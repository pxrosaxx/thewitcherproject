...
const OVERVIEW =
    ...
    '4. Przebijaj się przez lochy i bossów — `/loch`\n' +
...
const TOPICS = [
    {
        ...
        body:
            ...
            'Gdy okrzepniesz, ruszaj na `/loch` i `/arena`. Reszta — kowal, alchemia, komplety, ' +
    ...
    },
    {
        ...
        body:
            ...
            '**Energia:** *Punkty akcji* (loch) i *Awanturniczość* (karczma) odnawiają się z czasem — ' +
            'Awanturniczość resetuje się codziennie. Bez energii musisz poczekać.'
    },
    {
        key: 'walka',
        label: 'Aktywności i walka',
        short: 'Karczma, loch, arena',
        title: 'Aktywności i walka',
        body:
            '**`/karczma`** — zlecenia na potwory. Każda wygrana to exp, korony i szansa na łup oraz Ucho. ' +
            'Wygrane z rzędu budują **passę** (coraz większe nagrody). Kosztuje Awanturniczość.\n\n' +
            '**`/loch`** — krainy podzielone na etapy zakończone bossem. Pokonuj ich po kolei; ' +
            'finałowy boss kończy lochę i daje gwarantowany, lepszy łup. Kosztuje Punkty akcji.\n\n' +
    ...
    },
    {
        ...
        body:
            ...
            '**Zestaw:** możesz mieć aktywną 1 miksturę z każdej kategorii. Każda walka w **lochu i karczmie** ' +
    ...
    },
    {
        ...
        title: 'Gildie',
        body:
            '**`/gildia`** — wspólne granie w stylu SFGame.\n\n' +
    ...
    },
    {
        ...
        title: 'Waluty',
        body:
            '**Korony** — podstawowa waluta. Zdobywasz je w karczmie, lochu, arenie i z codziennej nagrody. ' +
    ...
    },
    {
        ...
        body:
            ...
            '**Aktywności:** `/karczma` · `/loch` · `/arena` · `/dziennie`\n' +
            ...
            '**Admin:** `/loch-kreator` _(tworzenie własnych lochów — tylko administrator)_'
    }
];
